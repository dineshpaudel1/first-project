        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="user.php">
                    ...
                    <span class="links_name">User Detail</span>
                </a>
            </li>
            <li>
                <a href="Trainer.php">
                    <i class="bx bx-list-ul"></i>
                    <span class="links_name">Trainer Detail</span>
                </a>
            </li>
            <li>
                <a href="packaged.php">
                    <i class="bx bx-pie-chart-alt-2"></i>
                    <span class="links_name">Package detail</span>
                </a>
            </li>
            <li>
                <a href="enrolled.php">
        ...
        <nav>
            ...
            <form action="search.php" method="GET">
                <div class="search-box">
                    ...
                    <button><i class="bx bx-search"></i></button></a>
                </div>
            </form>
        </nav>
    </div>
